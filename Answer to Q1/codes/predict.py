...
model.load_state_dict(pt.load('./result/model.pth', map_location=device))
...
for x, y in test_loader:
    ...
    dis_list.append((logits - y).abs().detach().numpy())

print(f'===== loss:', np.array(loss_list).mean())
print("Average error: ", np.array(dis_list).mean())
print("Max error: ", np.array(dis_list).max())
